                        ...
                        <div className="col-12 col-lg-7 m-auto">
                            <div className="row">
                                <div className="col-12">
                                    ...
                                    <div className="mt-4">
                                        <span><Link href=""><i className="icon icon-medium icon-facebook icon-white-bg px-3" aria-label="facebook page petnamesgenerators" aria-hidden="true"></i></Link></span>
                                        <span><Link href=""><i className="icon icon-medium icon-instagram icon-white-bg px-3" aria-label="instragram page petnamesgenerators"></i></Link></span>
                                        <span><Link href=""><i className="icon icon-medium icon-pinterest icon-white-bg px-3" aria-label="pinterest page petnamesgenerators"></i></Link></span>
                                    </div>
